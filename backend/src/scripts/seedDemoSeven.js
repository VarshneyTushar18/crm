...
require("../models/appModels/InstallationSummary");
...
require("../models/appModels/JobComment");
require("../models/appModels/Leave");
require("../models/appModels/Rfq");
require("../models/appModels/PurchaseOrder");
require("../models/appModels/Supplier");
require("../models/appModels/Site");
...
const { seedDemoSeven } = require("../setup/seedDemoSeven");
const { ensureCustomerPortalData } = require("../setup/seedDemoData");
...
async function run() {
  ...
  await seedDemoSeven({ fresh: true, force });
